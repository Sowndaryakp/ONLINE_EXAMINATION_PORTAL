...
public class StudentController {
    ...
    public ResponseEntity<?> loginStudent(@RequestBody Student student) {
        ...
        if (authenticatedStudent != null) {
            ...
            boolean registrationStatus = authenticatedStudent.isRegistrationStatus();
            AuthResponse response = new AuthResponse("Login successful", token,registrationStatus ); // Create AuthResponse object
